...
\textbf{5-method fine-mapping at 41 leads.} We fine-mapped a
...
MAF~$\geq$~0.05) using GAFM, HBP, SuSiE, SuSiE-inf and FINEMAP-inf.
At the strict variant-level criterion (the QTN's chr:pos in the
95\% credible set within $\pm$10\,kb), per-method recovery of the
21 Niu QTNs is GAFM 10/21 (48\%), HBP 9/21 (43\%), SuSiE 10/21
(48\%), SuSiE-inf 8/21 (38\%) and FINEMAP-inf 3/21 (14\%; the
FinucaneLab SSS sampler returns all-zero PIPs at extreme
$p{<}10^{-100}$ leads and is filtered as a method-level
non-result there); top-1-PIP exact-position recovery is led by
SuSiE 6/21 (29\%). For the 7 NEW candidate genes flagged by Niu
\emph{et al.}\ 2021 at locus-level resolution, recovery is HBP/SuSiE/SuSiE-inf
5--6/7 (71--86\%), GAFM 3/7 (43\%) and FINEMAP-inf 5/7 (71\%);
gene-level recovery against the Ren \emph{et al.}\ 2023
\cite{ren2023rice} grain-quality catalogue is 17--18/$\sim$118
across all five methods (per-method, per-tier breakdown in
Supplementary Table~S7; per-locus credible sets in
