...
resolution}, and at the variant-level metric the v0.1.5 augmented GAFM-MX, HBP-MX and
GAFM+HBP-ENS reach 62--67\% recovery with a top-1-PIP exact-position rate of \textbf{47.6\%
(10 of 21) --- the highest of any method tested, beating SuSiE (29\%) and SBayesRC (14\%)
...
achieves 95\% Tier-1 recovery; v0.1.5 demonstrates that this gap can be substantially
closed by importing SBayesRC's 4-component mixture prior into GAFM/HBP as a posterior
reweighting step.
\end{itemize}
