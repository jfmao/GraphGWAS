...
resolution and \textbf{20 of 21 at variant-level resolution by SBayesRC} (16 exact-position
matches at $\pm$10\,kb)} on the same 3kRG panel under a uniform 6-method fine-mapping
panel (GAFM, HBP, SuSiE, SuSiE-inf, FINEMAP-inf, SBayesRC). The SBayesRC LD reference
was built from scratch for 3kRG (gctb 2.05beta + R LDstep1--4 over 23 targeted
$\pm$250\,kb blocks; ~10 min compute) since no public rice-specific reference exists.
\end{itemize}
