...
reported by Niu \emph{et al.}\ 2021 \emph{BMC Genomics} are recovered (95\%) at GWAS lead
resolution, and 10/21 (48\%) at variant-level resolution by both GAFM and SuSiE} on the
same 3kRG panel under a uniform 5-method fine-mapping panel (GAFM, HBP, SuSiE, SuSiE-inf,
FINEMAP-inf).
\end{itemize}
