...
variant-level (chr:pos in the 95\% CS within $\pm$10\,kb), the v0.1.5
9-method panel gives:
\textbf{SBayesRC 20/21 (95\%, 16 exact-position matches);
GAFM-MX = ENS 14/21 (67\%, 10 exact);
HBP-MX 13/21 (62\%, 7 exact);
SuSiE 12/21 (57\%);
HBP 10/21 (48\%);
...
method, exceeding SuSiE (28.6\%) and SBayesRC (14.3\%). Per-method,
...
on the deflated z-scores ($\pi=(0.005, 0.003, 0.001, 0.001)$ within
non-zero components, $\gamma=(0.001, 0.01, 0.1, 1.0)$); details in
Methods. The IRRI row's validation count uses Ren
