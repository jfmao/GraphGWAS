...
\toprule
                 & \multicolumn{2}{c}{\textbf{Yeast (1011)}: $n=245$ leads}
                 & \multicolumn{2}{c}{\textbf{Arabidopsis (1001G)}: $n=54$ leads}
                 & \multicolumn{2}{c}{\textbf{IRRI rice (3kRG)}: $n=72$ leads} \\
\cmidrule(lr){2-3}\cmidrule(lr){4-5}\cmidrule(lr){6-7}
\textbf{Method}  & CS$=$1 & median top PIP & CS$=$1 & median top PIP & CS$=$1 & median top PIP \\
\midrule
