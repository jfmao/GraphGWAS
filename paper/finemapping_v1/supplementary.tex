...
Rice (3kRG, grain)$^\dagger$ &  4 & 41  & 1 (2\%)   & 4 (10\%)  & 28 (68\%)  & 1 (2\%)  & 20/21 (95\%) \\
...
catalogue at \emph{variant-level} resolution: a QTN is counted as
``validated'' if its chr:pos appears in the 95\% credible set within
$\pm$10\,kb. The reported 20/21 (95\%) is from SBayesRC, the
strongest of the six methods on this rice grain pass; the canonical
SuSiE family (SuSiE, SuSiE-inf) reaches 8--10/21 (38--48\%); the
graph-augmented GAFM/HBP reach 9--10/21 (43--48\%); FINEMAP-inf
3/21 (14\%; SSS sampler fails at extreme $p<10^{-100}$). At the
looser locus-level (any fine-mapped lead within $\pm$100\,kb of the
QTN at $p\leq5\times10^{-8}$), all 6 methods recover 20 of 21 (95\%). The IRRI row's validation count uses Ren
