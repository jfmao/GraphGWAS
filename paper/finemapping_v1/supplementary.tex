...
Rice (3kRG, grain)$^\dagger$ &  4 & 41  & 1 (2\%)   & 4 (10\%)  & 28 (68\%)  & 1 (2\%)  & 10/21 (48\%) \\
...
\midrule
\textbf{Total}         & 74 & 733 & \textbf{23} & \textbf{79} & \textbf{315} & \textbf{19} & \textbf{102} \\
\bottomrule
\end{tabular}
...
$\pm$10\,kb (the strict variant-level criterion; reported here for GAFM
which gives 10/21 = 48\%). At the looser locus-level (any fine-mapped
lead within $\pm$100\,kb of the QTN at $p\leq5\times10^{-8}$), 20 of 21
Niu QTNs are recovered (95\%). The IRRI row's validation count uses Ren
...
SBayesRC \cite{zheng2024leveraging} is omitted from this rice panel
because the public LD reference is human HM3-EUR; an in-sample 3kRG
HM3-substitute LD reference is being prepared and will be added in
the next revision.
