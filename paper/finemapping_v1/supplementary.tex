...
\subsection*{Supplementary Table S5b --- 3kRG grain weight + shape whole-genome scan summary (Niu et al. 2021 phenotype reference panel)}
...
per-tier breakdown: Supplementary Table~S7. The mixture-prior step
...
multiplicative reweighting (Methods, Supplementary Table~S7\,c). The IRRI row's validation count uses Ren
...
per-tier recovery for the grain pass is in Supplementary Table~S7,
...
\subsection*{Supplementary Table S7 --- 3kRG grain weight + shape: 5-method ground-truth recovery scorecard}
...
\subsection*{Supplementary Table S8 --- 3kRG grain pass: per-locus 5-method credible-set comparison}

\input{tables/grain_table_s8_per_locus.tex}

\clearpage

\subsection*{Supplementary Table S9 --- Cross-species CS=1 sharpening of GAFM-MX, HBP-MX and ENS on real GWAS leads}
...
(Supplementary Table~S8) because real GWAS lead loci have stronger marginal
...
\subsection*{Supplementary Table S10 --- Chr22 head-to-head across signal strength (eight-method panel)}
