...
(\textbf{Bottom-left}) Quantile--quantile plots show inflation
$\lambda_{GC} \in [1.41, 1.78]$, consistent with the well-documented
3kRG XI/GJ subpopulation structure under PC1--PC10 correction.
$\lambda_{GC}$ deflation is applied per trait before fine-mapping.
