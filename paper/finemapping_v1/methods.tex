...
RicePPINet PPI). SBayesRC \cite{zheng2024leveraging} was omitted
because the public LD reference is human HM3-EUR; an in-sample
3kRG HM3-substitute LD reference for SBayesRC is being prepared
and will be added in the next revision. Validation used 250~kb-window overlap
